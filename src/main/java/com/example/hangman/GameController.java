...
public class GameController {
    ...
    public String getWord(HttpSession session) {
        ...
        return chosenWord + ":" + blanks.toString().trim();
    }

    @GetMapping("/checkLetter")
    public Map<String, Object> checkLetter(@RequestParam String letter, HttpSession session) {
        ...
        response.put("chosenWord", chosenWord);
